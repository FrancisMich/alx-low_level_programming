 ...
 *
 * @size: size of the new sorted hash
...
/**
 * add_n_shash - adds element to the sorted hash
 *
 * @h: pointer to sorted hash
 * @key: key to addd
...
/**
 * add_i_shash - adding  a node to the hash table
 *
 * @ht: pointer to the sorted hash
 * @new: new node to be add 
 * Return: nothing
 */
...
/**
 * shash_table_set - to add element to hash table
 *
 * @ht: pointer to the sorted hash table
 * @key: key to add
 * @value: value associated with the key
 * Return: 1 if successes, 0 if error occurs
 */
...
/**
 * shash_table_get - retrieves a value associated with a key in sorted hased table
 *
...
/**
 * shash_table_print_rev - prints the keys and values of the hash table
 * in reverse order
 *
 * @ht: pointer to the hash table
 * Return: no return
